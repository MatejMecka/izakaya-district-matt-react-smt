...
export default function Trade_IZD_To_XLM() {
  ...
  const handleAlbedo = async () => {
    ...
    albedo.exchange({
      sell_asset_code: 'IZD',
      sell_asset_issuer: 'GACHXSM2GCZSLVKFD76D7MBLIIZARHRTO4R4OMZ5NNYRR3WCYNWGOFRK',
      amount: `${value}`,
      max_price: '1',
      network: 'testnet',
    ...
    return (
      <div>
        ...
        <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
          <DialogTitle id="form-dialog-title">Trade IZD to XLM</DialogTitle>
          <DialogContent>
            <DialogContentText>
            ...
            <TextField
              ...
              margin="dense"
              id="name"
              label="How Much IZD do you want to trade for XLM?"
              type="number"
              value={value}
